...
map("n", "<leader>li", "<CMD>checkhealth vim.lsp<CR>", defaults_opts)
...
map("n", "<leader>qs", "<CMD>SessionManager load_session<CR>", defaults_opts)
map("n", "<leader>qd", "<CMD>SessionManager delete_session<CR>", defaults_opts)
map("n", "<leader>qS", "<CMD>SessionManager save_current_session<CR>", defaults_opts)
map("n", "<leader>qc", "<CMD>SessionManager load_current_dir_session<CR>", defaults_opts)
map("n", "<leader>ql", "<CMD>SessionManager load_last_session<CR>", defaults_opts)
...
-- trouble
map("n", "<leader>xx", "<CMD>Trouble diagnostics toggle<CR>", defaults_opts)
